...
/// PlaybackMetadataGetNetwork is used to poll for metadata changes. 
public class PlaybackMetadataGetNetwork: Network {
    ...
    /// Initializes an instance of PlaybackMetadataGetNetwork for polling metadata changes.
