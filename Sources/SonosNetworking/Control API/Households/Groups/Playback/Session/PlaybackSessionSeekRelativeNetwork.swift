...
/// PlaybackSessionSeekRelativeNetwork is used to seek to the a relative position in the track with the specified cloud queue itemId.
...
public class PlaybackSessionSeekRelativeNetwork: Network {
    ...
    /// Initializes an instance of PlaybackSessionSeekRelativeNetwork to seek to the a relative position in the track with the specified cloud queue itemId.
    ...
    override func preparedURL() -> URLConvertible {
        return "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/seekRelative"
    }
