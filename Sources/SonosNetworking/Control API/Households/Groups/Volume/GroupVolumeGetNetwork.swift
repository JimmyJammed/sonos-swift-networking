...
/// GroupVolumeGetNetwork is used to get the volume and mute state of a group.
public class GroupVolumeGetNetwork: Network {
    ...
    /// Initializes an instance of GroupVolumeGetNetwork to get the volume and mute state of a group.
