...
/// GroupVolumeSubscribeNetwork is used to subscribe to events in the groupVolume namespace.
public class GroupVolumeSubscribeNetwork: Network {
    ...
    /// Initializes an instance of GroupVolumeSubscribeNetwork for subscribing to the groupVolume events.
