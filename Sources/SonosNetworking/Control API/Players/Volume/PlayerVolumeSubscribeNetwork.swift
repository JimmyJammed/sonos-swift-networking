...
/// PlayerVolumeSubscribeNetwork is used to subscribe to events in the playerVolume namespace.
public class PlayerVolumeSubscribeNetwork: Network {
    ...
    /// Initializes an instance of PlayerVolumeSubscribeNetwork for subscribing to the playerVolume events.
