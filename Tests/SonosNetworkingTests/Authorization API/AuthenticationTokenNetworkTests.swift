...
final class AuthenticationTokenNetworkTests: XCTestCase {
    private var subject: AuthenticationTokenNetwork!
    ...
    override func setUp() {
        subject = AuthenticationTokenNetwork(authorizationCode: MockedData.authorizationCode,
                                             encodedKeys: MockedData.encodedKeys,
                                             redirectURI: MockedData.redirectUri,
...
fileprivate final class MockedData {
    ...
    public static let authorizationCode: String = "authorizationCode"
    public static let redirectUri: String = "redirectUri"
