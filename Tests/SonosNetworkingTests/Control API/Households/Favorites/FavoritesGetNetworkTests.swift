...
final class FavoritesGetNetworkTests: XCTestCase {
    private var subject: FavoritesGetNetwork!
    ...
    override func setUp() {
        subject = FavoritesGetNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/favorites"
