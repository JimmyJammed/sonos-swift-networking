...
final class FavoritesSubscribeNetworkTests: XCTestCase {
    private var subject: FavoritesSubscribeNetwork!
    ...
    override func setUp() {
        subject = FavoritesSubscribeNetwork(accessToken: MockedData.accessToken,
