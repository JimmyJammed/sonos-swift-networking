...
final class FavoritesUnsubscribeNetworkTests: XCTestCase {
    private var subject: FavoritesUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = FavoritesUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/favorites/subscription"
