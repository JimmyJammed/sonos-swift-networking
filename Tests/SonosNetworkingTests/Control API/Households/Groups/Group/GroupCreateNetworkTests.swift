...
final class GroupCreateNetworkTests: XCTestCase {
    private var subject: GroupCreateNetwork!
    ...
    override func setUp() {
        subject = GroupCreateNetwork(accessToken: MockedData.accessToken,
                                     householdId: MockedData.householdId,
                                     playerIds: MockedData.playerIds,
                                     musicContextGroupId: MockedData.musicContextGroupId,
...
fileprivate final class MockedData {
    ...
    public static let playerIds: [String] = [
        "playerId1", "playerId2"
    ]
    public static let musicContextGroupId: String = "musicContextGroupId"
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/groups/createGroup"
