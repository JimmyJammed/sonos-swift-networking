...
final class GroupModifyMembersNetworkTests: XCTestCase {
    private var subject: GroupModifyMembersNetwork!
    ...
    override func setUp() {
        subject = GroupModifyMembersNetwork(accessToken: MockedData.accessToken,
                                            groupId: MockedData.groupId,
                                            playerIdsToAdd: MockedData.playerIdsToAdd,
                                            playerIdsToRemove: MockedData.playerIdsToRemove,
...
fileprivate final class MockedData {
    ...
    public static let playerIdsToAdd: [String] = [
        "playerId1",
        "playerId2"
    ]
    public static let playerIdsToRemove: [String] = [
        "playerId3",
        "playerId4"
    ]
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/groups/modifyGroupMembers"
