...
final class GroupSetMembersNetworkTests: XCTestCase {
    private var subject: GroupSetMembersNetwork!
    ...
    override func setUp() {
        subject = GroupSetMembersNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/groups/setGroupMembers"
