...
final class GroupSubscribeNetworkTests: XCTestCase {
    private var subject: GroupSubscribeNetwork!
    ...
    override func setUp() {
        subject = GroupSubscribeNetwork(accessToken: MockedData.accessToken,
