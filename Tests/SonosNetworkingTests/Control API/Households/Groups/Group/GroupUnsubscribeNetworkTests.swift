...
final class GroupUnsubscribeNetworkTests: XCTestCase {
    private var subject: GroupUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = GroupUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/groups/subscription"
