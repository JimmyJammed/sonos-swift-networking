...
final class PlaybackMetadataGetNetworkTests: XCTestCase {
    private var subject: PlaybackMetadataGetNetwork!
    ...
    override func setUp() {
        subject = PlaybackMetadataGetNetwork(accessToken: MockedData.accessToken,
