...
final class PlaybackMetadataSubscribeNetworkTests: XCTestCase {
    private var subject: PlaybackMetadataSubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaybackMetadataSubscribeNetwork(accessToken: MockedData.accessToken,
