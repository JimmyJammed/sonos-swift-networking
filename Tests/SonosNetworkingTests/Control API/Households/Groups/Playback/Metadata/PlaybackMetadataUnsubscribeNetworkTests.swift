...
final class PlaybackMetadataUnsubscribeNetworkTests: XCTestCase {
    private var subject: PlaybackMetadataUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaybackMetadataUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playbackMetadata/subscription"
