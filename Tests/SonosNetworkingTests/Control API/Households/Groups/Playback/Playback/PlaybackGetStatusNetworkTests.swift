...
final class PlaybackGetStatusNetworkTests: XCTestCase {
    private var subject: PlaybackGetStatusNetwork!
    ...
    override func setUp() {
        subject = PlaybackGetStatusNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback"
