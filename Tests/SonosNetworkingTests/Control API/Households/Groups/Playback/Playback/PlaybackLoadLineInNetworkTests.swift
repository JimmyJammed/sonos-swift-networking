...
final class PlaybackLoadLineInNetworkTests: XCTestCase {
    private var subject: PlaybackLoadLineInNetwork!
    ...
    override func setUp() {
        subject = PlaybackLoadLineInNetwork(accessToken: MockedData.accessToken,
                                            groupId: MockedData.groupId,
                                            deviceId: MockedData.deviceId,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/lineIn"
