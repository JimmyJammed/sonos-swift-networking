...
final class PlaybackPauseNetworkTests: XCTestCase {
    private var subject: PlaybackPauseNetwork!
    ...
    override func setUp() {
        subject = PlaybackPauseNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/pause"
