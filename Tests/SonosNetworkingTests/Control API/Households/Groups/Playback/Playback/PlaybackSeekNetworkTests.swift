...
final class PlaybackSeekNetworkTests: XCTestCase {
    private var subject: PlaybackSeekNetwork!
    ...
    override func setUp() {
        subject = PlaybackSeekNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let positionMillis: UInt = 3000
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/seek"
