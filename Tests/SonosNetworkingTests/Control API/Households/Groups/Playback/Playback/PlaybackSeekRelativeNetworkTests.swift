...
final class PlaybackSeekRelativeNetworkTests: XCTestCase {
    private var subject: PlaybackSeekRelativeNetwork!
    ...
    override func setUp() {
        subject = PlaybackSeekRelativeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let deltaMillis: Int = 3000
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/seekRelative"
