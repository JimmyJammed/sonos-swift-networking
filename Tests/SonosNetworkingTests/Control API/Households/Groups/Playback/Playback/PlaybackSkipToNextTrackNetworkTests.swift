...
final class PlaybackSkipToNextTrackNetworkTests: XCTestCase {
    private var subject: PlaybackSkipToNextTrackNetwork!
    ...
    override func setUp() {
        subject = PlaybackSkipToNextTrackNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/skipToNextTrack"
