...
final class PlaybackSkipToPreviousTrackNetworkTests: XCTestCase {
    private var subject: PlaybackSkipToPreviousTrackNetwork!
    ...
    override func setUp() {
        subject = PlaybackSkipToPreviousTrackNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/skipToPreviousTrack"
