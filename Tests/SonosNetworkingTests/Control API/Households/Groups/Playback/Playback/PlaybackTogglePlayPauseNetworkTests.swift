...
final class PlaybackTogglePlayPauseNetworkTests: XCTestCase {
    private var subject: PlaybackTogglePlayPauseNetwork!
    ...
    override func setUp() {
        subject = PlaybackTogglePlayPauseNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/togglePlayPause"
