...
final class PlaybackUnsubscribeNetworkTests: XCTestCase {
    private var subject: PlaybackUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaybackUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playback/subscription"
