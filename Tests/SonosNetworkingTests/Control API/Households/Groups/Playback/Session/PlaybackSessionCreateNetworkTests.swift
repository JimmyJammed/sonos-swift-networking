...
final class PlaybackSessionCreateNetworkTests: XCTestCase {
    private var subject: PlaybackSessionCreateNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionCreateNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playbackSession/create"
