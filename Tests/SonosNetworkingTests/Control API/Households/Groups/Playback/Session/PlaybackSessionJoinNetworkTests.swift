...
final class PlaybackSessionJoinNetworkTests: XCTestCase {
    private var subject: PlaybackSessionJoinNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionJoinNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playbackSession/join"
