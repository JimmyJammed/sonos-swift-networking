...
final class PlaybackSessionJoinOrCreateNetworkTests: XCTestCase {
    private var subject: PlaybackSessionJoinOrCreateNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionJoinOrCreateNetwork(accessToken: MockedData.accessToken,
                                                     groupId: MockedData.groupId,
                                                     accountId: MockedData.accountId,
                                                     appContext: MockedData.appContext,
                                                     appId: MockedData.appId,
                                                     customData: MockedData.customData,
...
fileprivate final class MockedData {
    ...
    public static let accountId: String = "accountId"
    public static let appContext: String = "appContext"
    public static let appId: String = "appId"
    public static let customData: String = "customData"
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playbackSession/joinOrCreate"
