...
final class PlaybackSessionLoadCloudQueueNetworkTests: XCTestCase {
    private var subject: PlaybackSessionLoadCloudQueueNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionLoadCloudQueueNetwork(accessToken: MockedData.accessToken,
                                                sessionId: MockedData.sessionId,
                                                httpAuthorization: MockedData.httpAuthorization,
                                                itemId: MockedData.itemId,
                                                playOnCompletion: MockedData.playOnCompletion,
                                                positionMillis: MockedData.positionMillis,
                                                queueBaseUrl: MockedData.queueBaseUrl,
                                                queueVersion: MockedData.queueVersion,
                                                trackMetadata: MockedData.trackMetadata,
                                                useHttpAuthorizationForMedia: MockedData.useHttpAuthorizationForMedia,
...
fileprivate final class MockedData {
    ...
    public static let positionMillis: UInt = 1500
    public static let queueBaseUrl: String = "queueBaseUrl"
    public static let queueVersion: String = "queueVersion"
    public static let trackMetadata: [String: Any] = [
        "trackMetadata": [
            "album": [
                "name": "Album Name"
            ],
            ...
            "imageUrl": "http://example.com/path_to_image_url",
            "durationMillis": 319000,
            "contentType": "audio/mpeg",
            "mediaUrl": "http://example.com/path_to_track_url"
          ]
    ]
    public static let useHttpAuthorizationForMedia: Bool = true
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/loadCloudQueue"
