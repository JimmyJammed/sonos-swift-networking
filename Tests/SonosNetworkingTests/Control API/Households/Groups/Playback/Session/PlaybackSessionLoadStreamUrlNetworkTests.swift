...
final class PlaybackSessionLoadStreamUrlNetworkTests: XCTestCase {
    private var subject: PlaybackSessionLoadStreamUrlNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionLoadStreamUrlNetwork(accessToken: MockedData.accessToken,
                                                      ...
                                                      stationMetadata: MockedData.stationMetadata,
...
fileprivate final class MockedData {
    ...
    public static let stationMetadata: [String: Any] = [
        "name": "Bruce Springsteen Radio",
        "type": "trackList.program",
        "id": [
            "serviceId": "7",
            "objectId": "program:52981234"
        ],
        "service": [
            "id": "7",
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/loadStreamUrl"
