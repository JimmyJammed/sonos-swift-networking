...
final class PlaybackSessionSeekNetworkTests: XCTestCase {
    private var subject: PlaybackSessionSeekNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionSeekNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/seek"
