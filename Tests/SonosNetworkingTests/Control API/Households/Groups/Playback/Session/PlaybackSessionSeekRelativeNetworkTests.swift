...
final class PlaybackSessionSeekRelativeNetworkTests: XCTestCase {
    private var subject: PlaybackSessionSeekRelativeNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionSeekRelativeNetwork(accessToken: MockedData.accessToken,
                                                     sessionId: MockedData.sessionId,
                                                     itemId: MockedData.itemId,
                                                     deltaMillis: MockedData.deltaMillis,
...
fileprivate final class MockedData {
    ...
    public static let deltaMillis: Int = 100
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/seekRelative"
