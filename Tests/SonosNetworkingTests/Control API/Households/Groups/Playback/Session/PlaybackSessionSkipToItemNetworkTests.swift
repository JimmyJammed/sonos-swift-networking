...
final class PlaybackSessionSkipToItemNetworkTests: XCTestCase {
    private var subject: PlaybackSessionSkipToItemNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionSkipToItemNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/skipToItem"
