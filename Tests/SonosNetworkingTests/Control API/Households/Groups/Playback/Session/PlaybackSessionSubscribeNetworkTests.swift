...
final class PlaybackSessionSubscribeNetworkTests: XCTestCase {
    private var subject: PlaybackSessionSubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionSubscribeNetwork(accessToken: MockedData.accessToken,
