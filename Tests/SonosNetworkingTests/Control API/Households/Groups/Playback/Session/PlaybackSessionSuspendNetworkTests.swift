...
final class PlaybackSessionSuspendNetworkTests: XCTestCase {
    private var subject: PlaybackSessionSuspendNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionSuspendNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/suspend"
