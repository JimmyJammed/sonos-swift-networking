...
final class PlaybackSessionUnsubscribeNetworkTests: XCTestCase {
    private var subject: PlaybackSessionUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionUnsubscribeNetwork(accessToken: MockedData.accessToken,
    ...
    func testSuccess() {
        ...
        do {
            ...
            let mock = Mock(url: url, dataType: .json, statusCode: 200, data: [.delete: mockedData])
            mock.register()
    ...
    func testFailure() {
        ...
        do {
            ...
            let mock = Mock(url: url, dataType: .json, statusCode: 400, data: [.delete: Data()], requestError: error)
            mock.register()
...
fileprivate final class MockedData {
    ...
    public static let expectedHTTPMethod: HTTPMethod = .delete
    public static let expectedEncoding: ParameterEncoding = JSONEncoding.default
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/subscription"
