...
final class PlaybackSessionRefreshCloudQueueNetworkTests: XCTestCase {
    private var subject: PlaybackSessionRefreshCloudQueueNetwork!
    ...
    override func setUp() {
        subject = PlaybackSessionRefreshCloudQueueNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/playbackSessions/\(sessionId)/playbackSession/refreshCloudQueue"
