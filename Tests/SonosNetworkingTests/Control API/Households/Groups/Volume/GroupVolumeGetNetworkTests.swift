...
final class GroupVolumeGetNetworkTests: XCTestCase {
    private var subject: GroupVolumeGetNetwork!
    ...
    override func setUp() {
        subject = GroupVolumeGetNetwork(accessToken: MockedData.accessToken,
