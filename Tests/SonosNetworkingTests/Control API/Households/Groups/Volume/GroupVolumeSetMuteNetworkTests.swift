...
final class GroupVolumeSetMuteNetworkTests: XCTestCase {
    private var subject: GroupVolumeSetMuteNetwork!
    ...
    override func setUp() {
        subject = GroupVolumeSetMuteNetwork(accessToken: MockedData.accessToken,
                                            groupId: MockedData.groupId,
                                            muted: MockedData.muted,
...
fileprivate final class MockedData {
    ...
    public static let muted: Bool = true
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/groupVolume/mute"
