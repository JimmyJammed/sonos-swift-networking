...
final class GroupVolumeSetNetworkTests: XCTestCase {
    private var subject: GroupVolumeSetNetwork!
    ...
    override func setUp() {
        subject = GroupVolumeSetNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/groupVolume"
