...
final class GroupVolumeSetRelativeVolumeNetworkTests: XCTestCase {
    private var subject: GroupVolumeSetRelativeVolumeNetwork!
    ...
    override func setUp() {
        subject = GroupVolumeSetRelativeVolumeNetwork(accessToken: MockedData.accessToken,
                                                      groupId: MockedData.groupId,
                                                      volumeDelta: MockedData.volumeDelta,
...
fileprivate final class MockedData {
    ...
    public static let volumeDelta: Int = 1
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/groupVolume/relative"
