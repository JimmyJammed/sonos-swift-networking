...
final class GroupVolumeSubscribeNetworkTests: XCTestCase {
    private var subject: GroupVolumeSubscribeNetwork!
    ...
    override func setUp() {
        subject = GroupVolumeSubscribeNetwork(accessToken: MockedData.accessToken,
