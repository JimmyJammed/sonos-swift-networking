...
final class GroupVolumeUnsubscribeNetworkTests: XCTestCase {
    private var subject: GroupVolumeUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = GroupVolumeUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/groupVolume/subscription"
