...
final class MusicServiceAccountsMatchNetworkTests: XCTestCase {
    private var subject: MusicServiceAccountsMatchNetwork!
    ...
    override func setUp() {
        subject = MusicServiceAccountsMatchNetwork(accessToken: MockedData.accessToken,
                                              householdId: MockedData.householdId,
                                              userIdHashCode: MockedData.userIdHashCode,
                                              nickname: MockedData.nickname,
                                              serviceId: MockedData.serviceId,
                                              linkCode: MockedData.linkCode,
                                              linkDeviceId: MockedData.linkDeviceId,
...
fileprivate final class MockedData {
    ...
    public static let userIdHashCode: String = "userIdHashCode"
    public static let nickname: String = "nickname"
    public static let serviceId: String = "serviceId"
    public static let linkCode: String = "linkCode"
    public static let linkDeviceId: String = "linkDeviceId"
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/musicServiceAccounts/match"
