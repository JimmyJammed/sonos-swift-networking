...
final class PlaylistsGetPlaylistNetworkTests: XCTestCase {
    private var subject: PlaylistsGetPlaylistNetwork!
    ...
    override func setUp() {
        subject = PlaylistsGetPlaylistNetwork(accessToken: MockedData.accessToken,
                                              householdId: MockedData.householdId,
                                              playlistId: MockedData.playlistId,
...
fileprivate final class MockedData {
    ...
    public static let playlistId: String = "playlistId"
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/playlists/getPlaylist"
    ...
    public static let expectedResults: [String: Any] = [
        ...
        "tracks": [
            [
                ...
                "album": "The Head On the Door (Remastered) [Bonus Version]",
                "artist": "The Cure"
            ],
            [
