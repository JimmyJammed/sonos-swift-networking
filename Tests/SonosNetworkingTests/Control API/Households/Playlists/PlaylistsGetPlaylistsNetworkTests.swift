...
final class PlaylistsGetPlaylistsNetworkTests: XCTestCase {
    private var subject: PlaylistsGetPlaylistsNetwork!
    ...
    override func setUp() {
        subject = PlaylistsGetPlaylistsNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/playlists"
