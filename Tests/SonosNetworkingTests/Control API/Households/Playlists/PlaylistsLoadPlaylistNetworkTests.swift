...
final class PlaylistsLoadPlaylistNetworkTests: XCTestCase {
    private var subject: PlaylistsLoadPlaylistNetwork!
    ...
    override func setUp() {
        subject = PlaylistsLoadPlaylistNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let playModes: [String] = [
        "playMode1",
        "playMode2"
    ]
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/groups/\(groupId)/playlists"
