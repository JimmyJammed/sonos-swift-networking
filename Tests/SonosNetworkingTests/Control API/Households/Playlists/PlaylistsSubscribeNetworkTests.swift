...
final class PlaylistsSubscribeNetworkTests: XCTestCase {
    private var subject: PlaylistsSubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaylistsSubscribeNetwork(accessToken: MockedData.accessToken,
