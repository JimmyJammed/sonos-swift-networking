...
final class PlaylistsUnsubscribeNetworkTests: XCTestCase {
    private var subject: PlaylistsUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = PlaylistsUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/households/\(householdId)/playlists/subscription"
