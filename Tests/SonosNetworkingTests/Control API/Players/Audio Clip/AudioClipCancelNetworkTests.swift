...
final class AudioClipCancelNetworkTests: XCTestCase {
    private var subject: AudioClipCancelNetwork!
    ...
    override func setUp() {
        subject = AudioClipCancelNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/audioClip/\(id)"
