...
final class AudioClipSubscribeNetworkTests: XCTestCase {
    private var subject: AudioClipSubscribeNetwork!
    ...
    override func setUp() {
        subject = AudioClipSubscribeNetwork(accessToken: MockedData.accessToken,
