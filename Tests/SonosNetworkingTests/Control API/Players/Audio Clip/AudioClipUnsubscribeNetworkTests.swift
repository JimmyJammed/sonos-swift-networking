...
final class AudioClipUnsubscribeNetworkTests: XCTestCase {
    private var subject: AudioClipUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = AudioClipUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/audioClip/subscription"
