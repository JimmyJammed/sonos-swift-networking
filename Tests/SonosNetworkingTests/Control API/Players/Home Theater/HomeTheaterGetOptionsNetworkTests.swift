...
final class HomeTheaterGetOptionsNetworkTests: XCTestCase {
    private var subject: HomeTheaterGetOptionsNetwork!
    ...
    override func setUp() {
        subject = HomeTheaterGetOptionsNetwork(accessToken: MockedData.accessToken,
