...
final class HomeTheaterLoadPlaybackNetworkTests: XCTestCase {
    private var subject: HomeTheaterLoadPlaybackNetwork!
    ...
    override func setUp() {
        subject = HomeTheaterLoadPlaybackNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/homeTheater"
