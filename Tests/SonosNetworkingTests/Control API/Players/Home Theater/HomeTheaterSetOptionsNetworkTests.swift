...
final class HomeTheaterSetOptionsNetworkTests: XCTestCase {
    private var subject: HomeTheaterSetOptionsNetwork!
    ...
    override func setUp() {
        subject = HomeTheaterSetOptionsNetwork(accessToken: MockedData.accessToken,
                                               playerId: MockedData.playerId,
                                               nightMode: MockedData.nightMode,
                                               enhanceDialog: MockedData.enhanceDialog,
...
fileprivate final class MockedData {
    ...
    public static let nightMode: Bool = true
    public static let enhanceDialog: Bool? = nil
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/homeTheater/options"
