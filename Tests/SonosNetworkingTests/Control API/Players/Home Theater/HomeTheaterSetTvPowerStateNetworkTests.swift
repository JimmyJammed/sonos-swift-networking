...
final class HomeTheaterSetTvPowerStateNetworkTests: XCTestCase {
    private var subject: HomeTheaterSetTvPowerStateNetwork!
    ...
    override func setUp() {
        subject = HomeTheaterSetTvPowerStateNetwork(accessToken: MockedData.accessToken,
                                                    playerId: MockedData.playerId,
                                                    tvPowerState: MockedData.tvPowerState,
...
fileprivate final class MockedData {
    ...
    public static let tvPowerState: String = "tvPowerState"
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/homeTheater/tvPowerState"
    public static let expectedHeaders: HTTPHeaders = [
        HTTPHeader(name: "Content-Type", value: "application/json"),
        HTTPHeader(name: "Authorization", value: "Bearer \(accessToken)")
    ]
    public static let expectedParameters: [String: Any] = [
