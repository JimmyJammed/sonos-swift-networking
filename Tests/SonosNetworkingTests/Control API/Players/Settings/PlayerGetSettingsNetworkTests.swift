...
final class PlayerGetSettingsNetworkTests: XCTestCase {
    private var subject: PlayerGetSettingsNetwork!
    ...
    override func setUp() {
        subject = PlayerGetSettingsNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedResults: [String: Any] = [
        "volumeMode": "PASS_THROUGH",
        "volumeScalingFactor": 0.8,
        "monoMode": false,
        "wifiDisable": false
    ]
