...
final class PlayerSetSettingsNetworkTests: XCTestCase {
    private var subject: PlayerSetSettingsNetwork!
    ...
    override func setUp() {
        subject = PlayerSetSettingsNetwork(accessToken: MockedData.accessToken,
                                           playerId: MockedData.playerId,
                                           volumeMode: MockedData.volumeMode,
                                           volumeScalingFactor: MockedData.volumeScalingFactor,
                                           monoMode: MockedData.monoMode,
                                           wifiDisable: MockedData.wifiDisable,
...
fileprivate final class MockedData {
    ...
    public static let volumeMode: String = "volumeMode"
    public static let volumeScalingFactor: Float = 0.35
    public static let monoMode: Bool? = nil
    public static let wifiDisable: Bool? = nil
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/settings/player"
