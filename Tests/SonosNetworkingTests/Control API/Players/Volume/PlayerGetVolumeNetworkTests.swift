...
final class PlayerGetVolumeNetworkTests: XCTestCase {
    private var subject: PlayerVolumeGetNetwork!
    ...
    override func setUp() {
        subject = PlayerVolumeGetNetwork(accessToken: MockedData.accessToken,
