...
final class PlayerSetMuteNetworkTests: XCTestCase {
    private var subject: PlayerSetMuteNetwork!
    ...
    override func setUp() {
        subject = PlayerSetMuteNetwork(accessToken: MockedData.accessToken,
