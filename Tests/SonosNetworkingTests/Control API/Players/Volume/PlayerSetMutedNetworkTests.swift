...
final class PlayerSetMutedNetworkTests: XCTestCase {
    private var subject: PlayerSetMutedNetwork!
    ...
    override func setUp() {
        subject = PlayerSetMutedNetwork(accessToken: MockedData.accessToken,
