...
final class PlayerSetRelativeVolumeNetworkTests: XCTestCase {
    private var subject: PlayerSetRelativeVolumeNetwork!
    ...
    override func setUp() {
        subject = PlayerSetRelativeVolumeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/playerVolume/relative"
