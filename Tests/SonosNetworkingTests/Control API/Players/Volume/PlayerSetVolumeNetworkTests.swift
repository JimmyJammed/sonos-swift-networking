...
final class PlayerSetVolumeNetworkTests: XCTestCase {
    private var subject: PlayerSetVolumeNetwork!
    ...
    override func setUp() {
        subject = PlayerSetVolumeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let muted: Bool? = nil
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/playerVolume"
