...
final class PlayerVolumeSubscribeNetworkTests: XCTestCase {
    private var subject: PlayerVolumeSubscribeNetwork!
    ...
    override func setUp() {
        subject = PlayerVolumeSubscribeNetwork(accessToken: MockedData.accessToken,
