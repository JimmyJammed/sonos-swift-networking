...
final class PlayerVolumeUnsubscribeNetworkTests: XCTestCase {
    private var subject: PlayerVolumeUnsubscribeNetwork!
    ...
    override func setUp() {
        subject = PlayerVolumeUnsubscribeNetwork(accessToken: MockedData.accessToken,
...
fileprivate final class MockedData {
    ...
    public static let expectedPreparedUrl: URLConvertible = "https://api.ws.sonos.com/control/api/v1/players/\(playerId)/playerVolume/subscription"
